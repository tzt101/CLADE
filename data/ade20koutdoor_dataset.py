...
class ADE20KOutdoorDataset(Pix2pixDataset):
    ...
    def modify_commandline_options(parser, is_train):
        ...
        parser.set_defaults(dataroot='/home/tzt/HairSynthesis/SPADE/datasets/ADEData2016_outdoor/')
        return parser
    ...
    def get_paths(self, opt):
        ...
        for p in all_images:
            ...
            elif p.endswith('.npy') and 'distances' in p and opt.add_dist:
                dist_paths.append(p)
